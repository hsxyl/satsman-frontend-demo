          ...
          <List.Item>
            <div className="p-4 bg-white rounded shadow hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-semibold mb-2">
                Pool Address:
              <span className="ml-2 text-sm text-blue-400">{shortenAddress(item.pool_address)}</span>
                </h3>
              <h3 className="text-lg font-semibold mt-4 mb-2">
                Business State:
              <span className="ml-2 text-sm text-amber-700">{pool_status_str(item.status)}</span>
                </h3>
              <a 
